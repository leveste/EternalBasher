...
First, you can get meath00k from the latest EntityHero release. Extract the XINPUT\1_3.DLL file in the "meathook_interface" folder to your DOOMEternal folder.
